...
export const stakePoolMetadatas: StakePoolMetadata[] = [
  ...
  
  {
    ...
    hideFooter: true,
    imageUrl: 'https://w7.pngwing.com/pngs/487/294/png-transparent-car-turbocharger-mitsubishi-lancer-evolution-engine-ritardo-del-turbo-car-exhaust-system-transport-engine.png',
    ...
    links: [
      ...
      {
        text: 'FARMS',
        value: 'https://raydium.io/farms/?tab=Ecosystem',
      },
    ],
    styles: {
      fontFamily: 'Industry, sans-serif',
